...
_MENDER_PART_IMAGE_DEPENDS:append:arm =     " u-boot:do_deploy"
_MENDER_PART_IMAGE_DEPENDS:append:aarch64 = " u-boot:do_deploy"

_MENDER_PART_IMAGE_DEPENDS:append_mender-uboot = " u-boot:do_deploy"
_MENDER_PART_IMAGE_DEPENDS:append_mender-grub = " grub-efi:do_deploy"
